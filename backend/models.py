...
class User(models.Model):
	...
	skills = models.ForeignKey(Skill, related_name="users")
	# events
	# collaborations
	# attending
	# event_jobs
...
class Event_Job(models.Model):
	...
	date_decided = models.IntegerField(min_value=0, max_value=2) #is date undecided(0), final(1), or flexible(2)
	...
	event_place = models.IntegerField(min_value=0, max_value=3)
